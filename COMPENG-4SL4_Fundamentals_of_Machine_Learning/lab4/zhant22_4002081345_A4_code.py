...
def NNClassifier(X, t, hidden_layer_sizes, initialize, epochs, learning_rate):
    ...
    return output_best, np.min(loss), w_1_best , w_2_best , w_2_best, entropy_loss
...
for n1 in n_values:
    for n2 in range(1, 8 - n1 + 1):
        ...
        for i in range(3):
            o, l ,_,_,_,_= NNClassifier(X_train, t_train, hidden_layer_sizes=(n1, n2), initialize=random_integers, epochs=10, learning_rate=0.005)
            ...
            for i in range(3):
                o_valid, _ ,w1,w2,w3,_= NNClassifier(X_valid, t_valid, hidden_layer_sizes=(n1, n2), initialize=random_integers, epochs=10, learning_rate=0.005)
                mis_error = misclassification_error(o_valid, t_valid)
...
train_output, l1,_,_,_,loss = NNClassifier(X_train, t_train, hidden_layer_sizes=(best_n1, best_n2), initialize=random_integers, epochs=20, learning_rate=0.005)
...
valid_output, l2,_,_,_ ,loss2= NNClassifier(X_valid, t_valid, hidden_layer_sizes=(best_n1, best_n2), initialize=random_integers, epochs=20, learning_rate=0.005)
...
test_output, l3 ,_,_,_,loss3 = NNClassifier(X_test, t_test, hidden_layer_sizes=(best_n1, best_n2), initialize=random_integers, epochs=20, learning_rate=0.005)
