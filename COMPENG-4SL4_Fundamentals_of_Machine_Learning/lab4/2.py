...
print(f"| {'n1':^10} | {'n2':^10} | {'Misclassification Rate':^20} |{'best_epoch':^10} |")
print(f"|{'-'*12}|{'-'*12}|{'-'*24}|{'-'*12}|")
...
for n1 in n_values:
    for n2 in range(1, 8 - n1 + 1):
        ...
        for i in range(3):
            o, l = NNClassifier(X_train, t_train, hidden_layer_sizes=(n1, n2), initialize=random_integers, epochs=50, learning_rate=0.005)
            ...
            for epoch in range(50):
                o_valid, _ = NNClassifier(X_valid_sub, t_valid_sub, hidden_layer_sizes=(n1, n2), initialize=random_integers, epochs=1, learning_rate=0.005)
        ...
        print(f"| {n1:^10} | {n2:^10} | {best_misclassification_error:^20.4f} | {epoch:^10.4f}")




    entropy_loss.append(best_entropy_loss)
    mis_rate.append(best_mis_rate)
...
#print("best weight is : ", best_weights)
